//Código desarollado por Semi, https://wa.me/5493492419916)
let handler = async(m, {conn, text, participants}) => {
  ...
  conn.sendMessage(m.chat, {text: text ? text : "@valu._16", mentions: participants.map(u => conn.decodeJid(u.id))}, {quoted: m})
  }} else if (m.quoted) {
